...
const steps = [
  {
    ...
    description: "Take a photo of the job site, record a quick video, or just type what you see. That's all we need.",
    icon: Camera,
    time: "10 sec",
  ...
  },
  {
    ...
    description: "Our AI analyzes the job, identifies materials, estimates labour, and creates a professional quote instantly.",
    icon: Zap,
    time: "47 sec",
  ...
  },
  {
    ...
    description: "Review the quote, make any tweaks, and send it off. Be the first to respond. Win the job.",
    icon: Send,
    time: "30 sec",
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            No complicated setup. No learning curve. Just faster quotes and more jobs.
          </p>
        </div>
              ...
              <div className="bg-white rounded-2xl p-8 border border-border/80 shadow-lg shadow-slate-200/50 hover:shadow-xl hover:shadow-slate-200/80 transition-all duration-300 h-full">
                ...
                <div className="flex items-center justify-between mb-6">
                  ...
                  <div className="flex items-center gap-2">
                    <span className="text-5xl font-bold text-slate-100 group-hover:text-slate-200 transition-colors">{step.number}</span>
                  </div>
                </div>
        ...
        <div className="mt-16 text-center">
          <p className="text-muted-foreground mb-4">
            Average time from photo to sent quote: <span className="font-bold text-foreground">1 minute 27 seconds</span>
          </p>
          <button
