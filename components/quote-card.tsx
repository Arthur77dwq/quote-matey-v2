  ...
  return (
    <div className="bg-white rounded-2xl shadow-2xl shadow-[#0a1628]/10 border border-border/80 p-5 w-full max-w-[300px]">
      ...
      <div className="flex items-center justify-between mb-4">
        ...
        <span className="text-[10px] bg-green-100 text-green-700 px-2 py-1 rounded-full font-semibold uppercase tracking-wide">
          Draft
        </span>
      </div>
      ...
      <div className="mb-4">
        ...
        <div className="flex flex-wrap gap-2">
          {materials.map((material, index) => (
            <span
              key={index}
              className="inline-flex items-center gap-1.5 text-xs bg-slate-100 text-foreground px-2.5 py-1.5 rounded-lg font-medium"
            >
