      ...
      <div className="relative max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center">
          ...
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-white mb-6 tracking-tight text-balance">
            ...
            <span className="block text-[#f57a0a]">stealing your next job.</span>
          </h2>
          
          <p className="text-xl text-white/80 mb-10 max-w-2xl mx-auto">
            Every day you wait costs you <span className="text-white font-semibold">$150-$500</span> in lost jobs. 
            <span className="block mt-2">How much longer can you afford to be slow?</span>
          </p>
          ...
          <div className="grid sm:grid-cols-4 gap-4 max-w-3xl mx-auto">
            <div className="bg-white/5 backdrop-blur-sm rounded-xl p-4 border border-white/10">
              ...
              <span className="text-white text-sm font-medium block">No Credit Card</span>
              <span className="text-white/50 text-xs">required to start</span>
            </div>
            <div className="bg-white/5 backdrop-blur-sm rounded-xl p-4 border border-white/10">
              <Clock className="w-6 h-6 text-[#f57a0a] mx-auto mb-2" />
              <span className="text-white text-sm font-medium block">2-Minute Setup</span>
              <span className="text-white/50 text-xs">quote in 5 mins</span>
            </div>
            <div className="bg-white/5 backdrop-blur-sm rounded-xl p-4 border border-white/10">
              <Shield className="w-6 h-6 text-[#f57a0a] mx-auto mb-2" />
              <span className="text-white text-sm font-medium block">30-Day Guarantee</span>
              <span className="text-white/50 text-xs">full refund, no questions</span>
            </div>
            <div className="bg-white/5 backdrop-blur-sm rounded-xl p-4 border border-white/10">
              <Users className="w-6 h-6 text-[#f57a0a] mx-auto mb-2" />
              <span className="text-white text-sm font-medium block">2,847+ Tradies</span>
