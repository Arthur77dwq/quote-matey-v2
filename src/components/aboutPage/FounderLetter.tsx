    ...
    <section className="flex justify-center items-center pt-25">
      <div className="w-full lg:w-200 flex flex-col justify-center items-center">
        <div className="flex justify-between items-end">
          <span className="h-18 w-10 rounded-r-3xl rounded-tr-none rounded-br-3xl border border-t-0 border-l-0 border-neutral-100" />
          <h2 className="text-nowrap px-2 text-6xl font-bold font-sans pb-5">
            How QuoteMatey <strong className="text-warning-600">started</strong>
          </h2>
          <span className="h-18 w-10 rounded-l-3xl rounded-tl-none rounded-bl-3xl border border-t-0 border-r-0 border-neutral-100" />
        </div>
        <div className="font-medium font-inter text-neutral-600 text-[1.15rem] w-full rounded-2xl border border-t-0 border-neutral-100 p-1.5">
          <Card className="overflow-hidden border-none relative bg-neutral-50 gap-12.5 p-12.5">
            ...
            <CardContent className="flex flex-col gap-6">
              ...
              <p>
                Building QuoteMatey has been a journey of learning, testing, and
                constantly improving based on real feedback from tradies in the
                field. Every feature we build is focused on saving time, winning
                more jobs, and helping tradies run their business more
                efficiently.
              </p>
              <p>
                Along the way, one thing stayed clear: software should work for
                tradies, not against them. Instead of overwhelming users with
                complicated tools, we designed QuoteMatey to turn photos, voice
                notes, and job details into professional quotes within minutes.
              </p>
            </CardContent>
            <CardFooter className="flex flex-col items-start h-fit pr-0 gap-1">
              <p className="font-semibold text-2xl text-neutral-900">Arthur</p>
              <p>Founder, QuoteMatey</p>
            </CardFooter>
            <Image
              className="absolute -bottom-30 -right-40 rounded-tl-[160]"
