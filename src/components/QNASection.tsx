...
const variants = {
  ...
  secondary: {
    container: 'gap-7.5 lg:gap-17.5 justify-between px-8 sm:px-15 py-15.75',
    left: 'flex justify-center items-center lg:block w-full max-w-160',
    right: 'w-full max-w-180',
  },
};
